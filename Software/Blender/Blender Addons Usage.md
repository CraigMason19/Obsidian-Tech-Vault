...
- I like to enable `cursor` and `modes` pie menus

| Combo          | Effect     |
| -------------- | ---------- |
| CTRL + ALT + A | Align tool |
...
- Select a loop of bevelled vertices
- Add the opposite bevelled vertices bottom

---
## ND

| Combo     | Effect                   | Conflicts                                                                                         |
| --------- | ------------------------ | ------------------------------------------------------------------------------------------------- |
| SHIFT + 2 | Opens the ND Main menu   |                                                                                                   |
